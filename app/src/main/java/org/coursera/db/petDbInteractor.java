...
public class petDbInteractor {
    ...
    public void insertFakeData(DataBase db){
        ...
        contentValues.put(DbConstants.TABLE_PETS_NAME, "Tuka");
        contentValues.put(DbConstants.TABLE_PETS_PIC, R.drawable.image2);

        db.insertFakeData(contentValues);

         contentValues = new ContentValues();
        contentValues.put(DbConstants.TABLE_PETS_NAME, "Flow");
        contentValues.put(DbConstants.TABLE_PETS_PIC, R.drawable.image1);

        db.insertFakeData(contentValues);

         contentValues = new ContentValues();
        contentValues.put(DbConstants.TABLE_PETS_NAME, "Yako");
        contentValues.put(DbConstants.TABLE_PETS_PIC, R.drawable.image3);

        db.insertFakeData(contentValues);

        contentValues = new ContentValues();
        contentValues.put(DbConstants.TABLE_PETS_NAME, "Bilma");
        contentValues.put(DbConstants.TABLE_PETS_PIC, R.drawable.image4);

        db.insertFakeData(contentValues);

        contentValues = new ContentValues();
        contentValues.put(DbConstants.TABLE_PETS_NAME, "Facka");
        contentValues.put(DbConstants.TABLE_PETS_PIC, R.drawable.image5);
