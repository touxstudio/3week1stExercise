...
public class DataBase extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
            String queryDbCreation = " CREATE TABLE " + DbConstants.TABLE_NAME_PETS + " ( " +
                    DbConstants.TABLE_PETS_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                    DbConstants.TABLE_PETS_NAME + " TEXT," +
                    DbConstants.TABLE_PETS_PIC       + " INTEGER" +
                    " ) " ;
            ...
            String queryDbCreationLikes = "CREATE TABLE " + DbConstants.TABLE_NAME_LIKES + "(" +
                    ...
                    " REFERENCES " + DbConstants.TABLE_NAME_PETS + "(" + DbConstants.TABLE_PETS_ID + ")"
                    +")";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXIST " + DbConstants.TABLE_NAME_PETS);
    ...
    public ArrayList<Pets> getAllPets (){
       ...
       String query = "SELECT p.* FROM " +
                DbConstants.TABLE_NAME_PETS +
                " AS p JOIN " + DbConstants.TABLE_LIKES_LIKES +
                " AS l on l."+ DbConstants.TABLE_PET_ID +
                " = p." + DbConstants.TABLE_PETS_ID + " ORDER BY l."+ DbConstants.TABLE_LIKES_LIKES + " ASC ";

        Log.v("QUERY", query);

        String query2 = "SELECT * FROM " + DbConstants.TABLE_NAME_PETS;
    ...
    public void insertFakeData(ContentValues contentValues){
        ...
        db.insert(DbConstants.TABLE_NAME_PETS, null, contentValues);
        db.close();
    }
